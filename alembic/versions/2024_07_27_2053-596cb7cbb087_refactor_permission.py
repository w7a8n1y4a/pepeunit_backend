...
def upgrade() -> None:
    ...
    op.add_column(
        "permissions", sa.Column("agent_unit_node_uuid", sa.UUID(), nullable=True)
    )
    op.add_column(
        "permissions", sa.Column("resource_repo_uuid", sa.UUID(), nullable=True)
    )
    op.add_column(
        "permissions", sa.Column("resource_unit_uuid", sa.UUID(), nullable=True)
    )
    op.add_column(
        "permissions", sa.Column("resource_unit_node_uuid", sa.UUID(), nullable=True)
    )
    ...
    op.create_foreign_key(
        None, "permissions", "users", ["agent_user_uuid"], ["uuid"], ondelete="CASCADE"
    )
    op.create_foreign_key(
        None,
        "permissions",
    ...
    op.create_foreign_key(
        ...
        "permissions",
        "units_nodes",
        ["resource_unit_node_uuid"],
        ["uuid"],
        ondelete="CASCADE",
    )
    op.create_foreign_key(
        None, "permissions", "units", ["agent_unit_uuid"], ["uuid"], ondelete="CASCADE"
    )
    op.create_foreign_key(
        None,
        "permissions",
...
def downgrade() -> None:
    ...
    op.add_column(
        "permissions",
        sa.Column("agent_uuid", sa.UUID(), autoincrement=False, nullable=False),
    )
    op.add_column(
        "permissions",
        sa.Column("resource_uuid", sa.UUID(), autoincrement=False, nullable=False),
    )
    ...
    op.drop_constraint(None, "permissions", type_="foreignkey")
    op.create_index(
        "ix_permissions_resource_uuid", "permissions", ["resource_uuid"], unique=False
    )
    op.create_index(
        "ix_permissions_agent_uuid", "permissions", ["agent_uuid"], unique=False
    )
