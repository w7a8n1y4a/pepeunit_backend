...
async def _lifespan(_app: FastAPI):
  ...
  +++*###********#################%%%%%%%     
     #######*+########%%%%%%%%%%%%%%%@        
       ######**###*******#*#%##%%%%@          
  _____  ##%%%%%%%%%%%%%%%%@@@@@@@ _ _    v{settings.version} - {settings.license}
 |  __ \   %%%%%%%%%%@@@@@@@@@@@  (_) |   Federated IoT Platform
 | |__) |__ _ __   ___ _   _ _ __  _| |_  Front: {settings.backend_http_type}://{settings.backend_domain}
 |  ___/ _ \ '_ \ / _ \ | | | '_ \| | __| REST:  {settings.backend_link_prefix}/docs
 | |  |  __/ |_) |  __/ |_| | | | | | |_  GQL:   {settings.backend_link_prefix}/graphql
 |_|   \___| .__/ \___|\__,_|_| |_|_|\__| TG:    {settings.telegram_bot_link}
