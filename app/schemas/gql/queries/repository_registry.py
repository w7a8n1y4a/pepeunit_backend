...
from app.schemas.gql.inputs.repository_registry import CommitFilterInput, RepositoryRegistryFilterInput
...
@strawberry.field()
def get_credentials(uuid: uuid_pkg.UUID, info: Info) -> Optional[OneRepositoryRegistryCredentialsType]:
    repository_registry_service = get_repository_registry_service_gql(info)
    return repository_registry_service.get_credentials(uuid)


@strawberry.field()
def get_repositories_registry(filters: RepositoryRegistryFilterInput, info: Info) -> RepositoriesRegistryResultType:
    repository_registry_service = get_repository_registry_service_gql(info)
